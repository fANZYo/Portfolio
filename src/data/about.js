module.exports = () => {
	return {
		...
		img: {
				...
				desktop: {
					small: {
						url: '/assets/aquaman-portrait.jpg?nf_resize=fit&w=500',
						size: '500',
					},
					medium: {
						url: '/assets/aquaman-portrait.jpg?nf_resize=fit&w=750',
						size: '750',
					},
					large: {
						url: '/assets/aquaman-portrait.jpg?nf_resize=fit&w=1000',
						size: '1000',
					},
				},
			alt: 'William freediving in Greece',
		},
	};
};
